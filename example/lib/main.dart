...
import 'package:fpi_gstreamer_video_player/fpi_gstreamer_video_player.dart';

void main() {
  FpiVideoPlayer.registerWith();
...
class _CameraViewPageState extends State<CameraViewPage> {
  ...
  void initState() {
    ...
    _controller = FpiVideoPlayerController.withGstreamerPipeline(
